@if ($request()->ajax())
  ...
  <div class="col-sm-8">
    ...
    <input type="text" name="values[]" class="form-control" value="" placeholder="option1 | option2 | option3">
    <label class="form-control-label">Additional Prices</label>
    <input type="text" name="prices[]" class="form-control" value="" placeholder="price1 | price2 | price3">
  </div>
@else
